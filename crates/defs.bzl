...
_NORMAL_DEPENDENCIES = {
    "": {
        _COMMON_CONDITION: {
            "libffi": "@crate_vendor__libffi-3.2.0//:libffi",
        },
    },
}
...
def crate_repositories():
    ...
    maybe(
        http_archive,
        name = "crate_vendor__cc-1.0.83",
        sha256 = "f1174fb0b6ec23863f8b971027804a42614e347eafb0a95bf0b12cdae21fc4d0",
        type = "tar.gz",
        urls = ["https://crates.io/api/v1/crates/cc/1.0.83/download"],
        strip_prefix = "cc-1.0.83",
        build_file = Label("@//crates:BUILD.cc-1.0.83.bazel"),
    )

    maybe(
        http_archive,
        name = "crate_vendor__libc-0.2.151",
        ...
        build_file = Label("@//crates:BUILD.libc-0.2.151.bazel"),
    )

    maybe(
        http_archive,
        name = "crate_vendor__libffi-3.2.0",
        sha256 = "ce826c243048e3d5cec441799724de52e2d42f820468431fc3fceee2341871e2",
        type = "tar.gz",
        urls = ["https://crates.io/api/v1/crates/libffi/3.2.0/download"],
        strip_prefix = "libffi-3.2.0",
        build_file = Label("@//crates:BUILD.libffi-3.2.0.bazel"),
    )

    maybe(
        http_archive,
        name = "crate_vendor__libffi-sys-2.3.0",
        sha256 = "f36115160c57e8529781b4183c2bb51fdc1f6d6d1ed345591d84be7703befb3c",
        type = "tar.gz",
        urls = ["https://crates.io/api/v1/crates/libffi-sys/2.3.0/download"],
        strip_prefix = "libffi-sys-2.3.0",
        build_file = Label("@//crates:BUILD.libffi-sys-2.3.0.bazel"),
    )

    return [
        struct(repo = "crate_vendor__libffi-3.2.0", is_dev_dep = False),
    ]
